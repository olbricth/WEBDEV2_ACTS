const apiBase = "http://localhost:8080/api/cars"; // make sure this matches your Spring Boot port
        ...
        .then(cars => {
            ...
            cars.forEach(car => {
              ...
              <tr class="text-center">
                ...
                <td class="border p-2">
                  <button onclick="openEditModal(${car.carId}, '${car.make}', '${car.model}', ${car.year}, '${car.color}')"
